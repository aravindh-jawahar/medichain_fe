...
import { Stethoscope, Mail, Lock, User, ArrowRight, Shield } from 'lucide-react';
...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen from-blue-50 via-white to-teal-50 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="block w-full px-3 py-3 border border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                >
